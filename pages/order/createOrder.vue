<template>
	<view>
		<uni-nav-bar left-icon="back"  title="创建订单" @clickLeft="go"></uni-nav-bar>
		<!-- 地址 -->
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				...
				<image class="rightjt" src="../../static/img/rightjt.png"></image>
			</view>
		...
		methods: {
			async getOrder(){
				const res = await this.myRuquest({
					url:'addons/xshop/cart?sku_id=14&quantity=1',
				})
				console.log(res);
			}
		}
